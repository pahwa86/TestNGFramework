...
static FirefoxDriver driver;
	...
	public static void playvideoandsubscribe() throws InterruptedException
	{
		...
		// Play 1st video
		List <WebElement> videoplay = driver.findElementsByXPath("//*[@class='yt-simple-endpoint style-scope ytd-rich-grid-video-renderer' and @id='video-title-link']");
		videoplay.get(0).click();
		Thread.sleep(3000);
		
	
		// Like Video played
		WebElement subscribe = driver.findElementByXPath("//*[@class='style-scope ytd-subscribe-button-renderer' and @role='button']");
		subscribe.click();
